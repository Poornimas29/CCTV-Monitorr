...
print(f"Scanning remote host {target_ip} for open ports in range 35000-50000...", flush=True)
threads = []
for port in range(35000, 50000):
...
if found:
    ...
    print(f"No open ports found on {target_ip} in the 35000-50000 range.", flush=True)
